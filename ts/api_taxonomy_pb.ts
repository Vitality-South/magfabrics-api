...
export interface Taxonomy {
     ...
     *
     * @generated from protobuf field: repeated string Brands = 1
     */
    brands: string[];
    /**
     * @gotags: dynamo:"TaxonomyUses"
     *
     * @generated from protobuf field: repeated string Uses = 2
     */
    uses: string[];
    /**
     * @gotags: dynamo:"TaxonomyColors"
     *
     * @generated from protobuf field: repeated string Colors = 3
     */
    colors: string[];
    /**
     * @gotags: dynamo:"TaxonomyDesigns"
     *
     * @generated from protobuf field: repeated string Designs = 4
     */
    designs: string[];
    /**
...
class Taxonomy$Type extends MessageType<Taxonomy> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Taxonomy): Taxonomy {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated string Brands */ 1:
                    message.brands.push(reader.string());
                    break;
                case /* repeated string Uses */ 2:
                    message.uses.push(reader.string());
                    break;
                case /* repeated string Colors */ 3:
                    message.colors.push(reader.string());
                    break;
                case /* repeated string Designs */ 4:
