...
export interface Inventory {
     ...
     *
     * @generated from protobuf field: string ProductCode = 1 [json_name = "ProductCode"];
     */
    productCode: string;
    /**
     * @gotags: dynamo:"InventoryRolls"
     *
     * @generated from protobuf field: repeated magnoliafabrics.Inventory.Roll Rolls = 2 [json_name = "Rolls"];
     */
    rolls: Inventory_Roll[];
    /**
     * @gotags: dynamo:"InventoryTotal"
     *
     * @generated from protobuf field: string Total = 3 [json_name = "Total"];
     */
    total: string;
    /**
     * @gotags: dynamo:"InventoryPO"
     *
     * @generated from protobuf field: repeated magnoliafabrics.Inventory.PO PurchaseOrders = 4 [json_name = "PurchaseOrders"];
     */
    purchaseOrders: Inventory_PO[];
    /**
     * @gotags: dynamo:"InventoryTotalOnPO"
     *
     * @generated from protobuf field: string TotalOnPO = 5 [json_name = "TotalOnPO"];
     */
    totalOnPO: string;
    /**
     * @gotags: dynamo:"InventoryOnBackorder"
     *
     * @generated from protobuf field: string OnBackorder = 6 [json_name = "OnBackorder"];
     */
    onBackorder: string;
}
/**
...
export interface Inventory_Roll {
     ...
     *
     * @generated from protobuf field: string Quantity = 2 [json_name = "Quantity"];
     */
    quantity: string;
}
/**
...
export interface Inventory_PO {
     ...
     *
     * @generated from protobuf field: string ETA = 1 [json_name = "ETA"];
     */
    eTA: string;
    /**
     * @gotags: dynamo:"InventoryPOAmount"
     *
     * @generated from protobuf field: string Amount = 2 [json_name = "Amount"];
     */
    amount: string;
}
...
class Inventory$Type extends MessageType<Inventory> {
    constructor() {
        super("magnoliafabrics.Inventory", [
            ...
            { no: 2, name: "Rolls", kind: "message", jsonName: "Rolls", repeat: 1 /*RepeatType.PACKED*/, T: () => Inventory_Roll },
            { no: 3, name: "Total", kind: "scalar", jsonName: "Total", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "PurchaseOrders", kind: "message", jsonName: "PurchaseOrders", repeat: 1 /*RepeatType.PACKED*/, T: () => Inventory_PO },
    ...
    create(value?: PartialMessage<Inventory>): Inventory {
        const message = { productCode: "", rolls: [], total: "", purchaseOrders: [], totalOnPO: "", onBackorder: "" };
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Inventory): Inventory {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string ProductCode = 1 [json_name = "ProductCode"];*/ 1:
                    message.productCode = reader.string();
                    break;
                case /* repeated magnoliafabrics.Inventory.Roll Rolls = 2 [json_name = "Rolls"];*/ 2:
                    message.rolls.push(Inventory_Roll.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* string Total = 3 [json_name = "Total"];*/ 3:
                    message.total = reader.string();
                    break;
                case /* repeated magnoliafabrics.Inventory.PO PurchaseOrders = 4 [json_name = "PurchaseOrders"];*/ 4:
                    message.purchaseOrders.push(Inventory_PO.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* string TotalOnPO = 5 [json_name = "TotalOnPO"];*/ 5:
                    message.totalOnPO = reader.string();
                    break;
                case /* string OnBackorder = 6 [json_name = "OnBackorder"];*/ 6:
    ...
    internalBinaryWrite(message: Inventory, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string ProductCode = 1 [json_name = "ProductCode"]; */
        if (message.productCode !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.productCode);
        /* repeated magnoliafabrics.Inventory.Roll Rolls = 2 [json_name = "Rolls"]; */
        ...
        /* string Total = 3 [json_name = "Total"]; */
        if (message.total !== "")
            writer.tag(3, WireType.LengthDelimited).string(message.total);
        /* repeated magnoliafabrics.Inventory.PO PurchaseOrders = 4 [json_name = "PurchaseOrders"]; */
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string ID = 1 [json_name = "ID"];*/ 1:
                    ...
                    break;
                case /* string Quantity = 2 [json_name = "Quantity"];*/ 2:
...
class Inventory_PO$Type extends MessageType<Inventory_PO> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Inventory_PO): Inventory_PO {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* string ETA = 1 [json_name = "ETA"];*/ 1:
                    message.eTA = reader.string();
                    break;
                case /* string Amount = 2 [json_name = "Amount"];*/ 2:
