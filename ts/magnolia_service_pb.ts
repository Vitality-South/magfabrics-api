...
/**
 * @generated from protobuf message magnoliafabrics.GetFabricBySKURequest
 */
export interface GetFabricBySKURequest {
    /**
     * @generated from protobuf field: string fabric_sku = 1
     */
    fabricSku: string;
}
/**
 * @generated from protobuf message magnoliafabrics.GetFabricBySKUResponse
 */
export interface GetFabricBySKUResponse {
    /**
     * @generated from protobuf field: magnoliafabrics.Fabric fabric = 1
     */
    fabric?: Fabric;
...
class GetAllFabricsResponse$Type extends MessageType<GetAllFabricsResponse> {
    constructor() {
        super("magnoliafabrics.GetAllFabricsResponse", [
            { no: 1, name: "fabrics", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Fabric }
        ]);
    }
...
class GetAllInventoryResponse$Type extends MessageType<GetAllInventoryResponse> {
    constructor() {
        super("magnoliafabrics.GetAllInventoryResponse", [
            { no: 1, name: "inventory", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Inventory }
        ]);
    }
...
class GetCleaningCodesResponse$Type extends MessageType<GetCleaningCodesResponse> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    ...
                    break;
                default: throw new globalThis.Error("unknown map entry field for magnoliafabrics.GetCleaningCodesResponse.cleaning_codes");
            }
        }
    ...
    internalBinaryWrite(message: GetCleaningCodesResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of globalThis.Object.keys(message.cleaningCodes)) {
...
// @generated message type with reflection information, may provide speed optimized methods
class GetFabricBySKURequest$Type extends MessageType<GetFabricBySKURequest> {
    constructor() {
        super("magnoliafabrics.GetFabricBySKURequest", [
            { no: 1, name: "fabric_sku", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<GetFabricBySKURequest>): GetFabricBySKURequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.fabricSku = "";
        if (value !== undefined)
            reflectionMergePartial<GetFabricBySKURequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetFabricBySKURequest): GetFabricBySKURequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* string fabric_sku */ 1:
                    message.fabricSku = reader.string();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: GetFabricBySKURequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string fabric_sku = 1; */
        if (message.fabricSku !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.fabricSku);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message magnoliafabrics.GetFabricBySKURequest
 */
export const GetFabricBySKURequest = new GetFabricBySKURequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetFabricBySKUResponse$Type extends MessageType<GetFabricBySKUResponse> {
    constructor() {
        super("magnoliafabrics.GetFabricBySKUResponse", [
            { no: 1, name: "fabric", kind: "message", T: () => Fabric }
        ]);
    }
    create(value?: PartialMessage<GetFabricBySKUResponse>): GetFabricBySKUResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<GetFabricBySKUResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetFabricBySKUResponse): GetFabricBySKUResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetFabricBySKUResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* magnoliafabrics.Fabric fabric = 1; */
        if (message.fabric)
            Fabric.internalBinaryWrite(message.fabric, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
...
class GetDiscontinuedFabricsResponse$Type extends MessageType<GetDiscontinuedFabricsResponse> {
    constructor() {
        super("magnoliafabrics.GetDiscontinuedFabricsResponse", [
            { no: 1, name: "fabrics", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => DiscontinuedFabric }
        ]);
    }
