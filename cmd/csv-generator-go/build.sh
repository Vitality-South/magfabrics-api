...
aws s3 cp magfabrics-csv-amd64-v${VERSION}.exe s3://images.magnoliaco.com/apps/magfabrics-csv-amd64-v${VERSION}.exe
aws s3 cp magfabrics-csv-386-v${VERSION}.exe s3://images.magnoliaco.com/apps/magfabrics-csv-386-v${VERSION}.exe
aws s3 cp magfabrics-csv-macos-amd64-v${VERSION} s3://images.magnoliaco.com/apps/magfabrics-csv-macos-amd64-v${VERSION}
aws s3 cp magfabrics-csv-macos-arm64-v${VERSION} s3://images.magnoliaco.com/apps/magfabrics-csv-macos-arm64-v${VERSION}